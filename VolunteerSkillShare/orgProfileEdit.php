...
<div class="fixedheader">Organization Profile</div>
...
<br/>
<div class="fixedheader">Contact Info</div>
<div class="fixedpanel">
    <br/>
    <table class="resultsTbl">
        <tr>
            ...
            <td class="resultsTdLeft">
                <input type="text" name="contactname" id="contactname" size="50" maxlength="200" 
                    value="<?php if(isset($orgdata)){ echo($orgdata['ContactName']); } ?>" required/>
            </td>
        </tr>
        <tr>
...
<br/>
<div class="fixedheader">General Info</div>
<div class="fixedpanel">
    <br/>
    <table class="resultsTbl">
        <tr>
