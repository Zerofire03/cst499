...
<form id="volProfileEdit" method="post" action="updateProfileProcess.php">
            ...
            <tr>
                ...
                <td class="resultsTdLeft">
                    <input type="tel" name="phone" id="phone" size="20" maxlength="20" 
                        value="<?php if(isset($orgdata)){ echo($volProfile[PhoneNumber]); } ?>" 
                        pattern="\d{3}[\-]\d{3}[\-]\d{4}"
                        title="###-###-####"/>
                </td>
            </tr>
    ...
    <br/>
    <button class="btn btn-primary" type="submit" value="update" title="Update Profile">Update Profile</button>
</form>
<br>
