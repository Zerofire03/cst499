...
echo '<nav class="navbar navbar-fixed-top">';
    ...
    echo '<div class="navbar-header nav-spacer">';
    echo '<a class="navbar-brand navbar-brand-image" href="index.php"><img alt="Volunteer Skill Share" src="./Images/handShakeHeart.png"></a>';
    echo '<a class="navbar-brand" href="index.php">Volunteer Skill Share</a>';
    echo '</div>';
